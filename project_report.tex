...
\\
\item The player's score, each time a brick is hit the score increments by 1 (variable): \verb+SCORE = 0+
...
Hit bricks with the ball to destroy them, each row of bricks requires 1 extra hit to be destroyed, make sure not to let the paddle reach the bottom of the screen!

You win once you destroy all the bricks
